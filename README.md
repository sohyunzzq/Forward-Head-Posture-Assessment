...
사용자의 측면을 실시간으로 촬영하여 구한 고개 각도와, 목에 부착한 플렉스 압력 센서로 구한 목의 기울기값으로 사용자의 거북목 여부를 판단한다. 거북목이라고 진단될 경우 경고음과 그래프를 통해 사용자에게 피드백을 제공하는 거북목 진단 시스템이다.

---

## 🔍 개발 배경  
 - 현대 사회 심각한 문제로 떠오르고 있는 거북목 증후군의 진단 및 예방을 유도하기 위해 프로젝트를 고안하였다.
 - 2022년 척추질환 신규 환자는 약 118만 명이며, 이 중 40%가 2-30대이다. 거북목 환자 수는 2016년 약 199만 명에서, 2020년에 약 221만 명으로 증가하였다.
 - 거북목을 방치할 경우 목디스크로 이어질 수 있고, 심한 경우 손발 마비 및 호흡곤란 등의 문제가 발생할 수 있다. 따라서, 앉아 있는 시간이 많은 현대인의 고질병인 거북목 증상의 진단 및 예방을 유도하기 위해 프로젝트를 고안하였다.
...
## 📚 참고 자료
- 정상 자세와 거북목 자세 (질병관리청)
<img width="690" height="582" alt="image" src="https://github.com/user-attachments/assets/cb7c4f1f-ccb5-41eb-bad3-82adaa9e9c28" />
